...
const dialogStyles = `
  ...
  [data-state="closed"][data-slot="dialog-overlay"] {
    animation: dialogOverlayHide 150ms cubic-bezier(0.16, 1, 0.3, 1);
  }
  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "fixed top-[50%] left-[50%] z-50 grid w-full max-w-[calc(100%-2rem)] gap-4 rounded-lg border bg-white p-6 shadow-lg sm:max-w-lg",
          className
        )}
        style={{
        ...
        {...props}
      >
        {/* Hidden title to satisfy accessibility requirement if none is provided by consumer */}
